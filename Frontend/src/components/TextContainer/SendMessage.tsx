  ...
  return (
    ...
    <div className="flex items-center">
        <input
          ...
          className="w-full p-2 rounded-md border border-gray-400 focus:outline-none focus:border-blue-500" value={messageSent} onChange={(e) => setmessageSent(e.target.value)}
        />
